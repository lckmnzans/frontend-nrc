<template>
    <div class="dashboard-content">
        ...
        <div class="dashboard-menu">
            <div class="box-clickable btn" @click.prevent="toListDocument('')">
                <span class="material-icons">folder</span>
                <span class="text">Semua Dokumen</span>
            </div>
            <div class="box-clickable btn" @click.prevent="toListDocument('A01')">
                <span class="material-icons">folder</span>
                <span class="text">Legalitas</span>
            </div>
            <div class="box-clickable btn" @click.prevent="toListDocument('A02')">
                <span class="material-icons">folder</span>
                <span class="text">Kontrak</span>
            </div>
            <div class="box-clickable btn" @click.prevent="toListDocument('A03')">
                <span class="material-icons">folder</span>
                <span class="text">Tenaga Ahli</span>
            </div>
            <div class="box-clickable btn" @click.prevent="toListDocument('A04')">
                <span class="material-icons">folder</span>
                <span class="text">CV</span>
            </div>
            <div class="box-clickable btn" @click.prevent="toListDocument('A05')">
                <span class="material-icons">folder</span>
                <span class="text">Keuangan</span>
            </div>
            <div class="box-clickable btn" @click.prevent="toListDocument('A06')">
                <span class="material-icons">folder</span>
                <span class="text">Proyek</span>
            </div>
            <div class="box-clickable btn" @click.prevent="toListDocument('A07')">
                <span class="material-icons">folder</span>
                <span class="text">Pengurus</span>
            </div>
            <div class="box-clickable btn" @click.prevent="toListDocument('A08')">
                <span class="material-icons">folder</span>
                <span class="text">Pemegang Saham</span>
            </div>
            <div class="box-clickable btn" @click.prevent="toListDocument('A09')">
                <span class="material-icons">folder</span>
                <span class="text">Peralatan</span>
            </div>
            <div class="box-clickable btn" @click.prevent="toListDocument('A10')">
                <span class="material-icons">folder</span>
                <span class="text">Lain-lain</span>
            </div>
            <div class="box-clickable btn" @click.prevent="toListDocument('B01')">
                <span class="material-icons">folder</span>
                <span class="text">Surat Masuk</span>
            </div>
            <div class="box-clickable btn" @click.prevent="toListDocument('B02')">
                <span class="material-icons">folder</span>
                <span class="text">Surat Keluar</span>
            </div>
            <div class="box-clickable btn" @click.prevent="toListDocument('C01')">
                <span class="material-icons">folder</span>
                <span class="text">Sertifikat</span>
            </div>
            <div class="box-clickable btn" @click.prevent="toListDocument('C02')">
                <span class="material-icons">folder</span>
